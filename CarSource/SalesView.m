...
- (void)awakeFromNib{
    ...
    _salesTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, self.frame.size.height) style:UITableViewStylePlain];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cell initAuthenticateLabelText:salesList.authenticateTypeName];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_isOpen[indexPath.row]) {
        ...
        CGFloat height = [self heightForConfigurationWithString:_str] + [self salesHeightViewArray:salesList.imageList] + 80;

        return height;
    }else{
        CGFloat hgt = [self heightConfigurationWithString:_str] + [self salesHeightViewArray:salesList.imageList] + 80 ;
        return hgt;
    }
