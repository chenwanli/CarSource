...
- (void)initServiceTableHeaderView{
    ...
    for (int i = 0; i<arr.count; i++) {
        ...
        UILabel *typeLabel = [[UILabel alloc]initWithFrame:CGRectMake(36, 50 *i +10, 70, 30)];
    ...
    UILabel *typeLabel = [[UILabel alloc]initWithFrame:CGRectMake(36, 10, 70, 30)];
    typeLabel.textColor = BLACK;
    typeLabel.font = [UIFont systemFontOfSize:16];
    typeLabel.text = @"申请认证";
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (section == 0) {
        ...
        _phoneField = [[UITextField alloc]initWithFrame:CGRectMake(36, 10, 170, 30)];
        ...
        addBtn.frame = CGRectMake( 210,10, 60, 30);
