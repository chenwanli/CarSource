...
//    [loginButton setTitle:@"点击登陆" forState:UIControlStateNormal];
    ...
    NSArray *array = [[NSArray alloc]initWithObjects:@"我的车源",@"我的担保",@"我的定金", nil];

    for (int i = 0; i < array.count; i++) {
        UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
        button.frame = CGRectMake(SCREEN_WIDTH/3*i, 200, SCREEN_WIDTH/3, 49);
        ...
        if (i == 0) {
            ...
            UIImageView *image  = [[UIImageView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH/3 *i, 203, 1, 44)];
