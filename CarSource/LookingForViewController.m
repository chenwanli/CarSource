...
//        return;
    ...
    [ResourcesRequest postAddRulesFoundInCarsRequestWithUserId:login.userId text:_textview.text userTypeId:_vehicleId seriesTypeId:_memberTypeId showCarList:^(NSMutableArray *saleArray, NSString *showCarList, NSString *errorMessage) {
