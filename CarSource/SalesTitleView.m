...
- (void)awakeFromNib{
    ...
    UITextField *textField = [[UITextField alloc]initWithFrame:CGRectMake(10, 10, SCREEN_WIDTH - 20, 30)];
    ...
    textField.placeholder = @"输入你要查找的车型、车号、价格";
    ...
    for (int i = 0; i < arr.count; i++) {
        ...
        brandButton.backgroundColor = [UIColor colorWithRed:241/255.0 green:251/255.0 blue:255/255.0 alpha:1];;
