...
- (void)awakeFromNib{
    ...
    _guaranteeTable.bounces = NO;
    _guaranteeTable.rowHeight = 160;
    _guaranteeTable.backgroundColor = [UIColor colorWithRed:235/255.0 green:236/255.0 blue:241/255.0 alpha:1];
