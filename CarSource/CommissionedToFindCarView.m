...
//    self.textView.autoresizingMask = UIViewAutoresizingFlexibleHeight;//自适应高度
    ...
    NSMutableAttributedString *mStr = [NSMutableAttributedString new];
    {
        ...
        UIImage *image = [UIImage imageNamed:@"Basic"];
        ...
        [mStr appendAttributedString:[[NSAttributedString alloc] initWithString:@"  " attributes:nil]];

    }

    {
        NSMutableAttributedString *omg = [[NSMutableAttributedString alloc] initWithString:@"委托找车说明"];
        omg.font = [UIFont systemFontOfSize:15];
        omg.color = [UIColor colorWithRed:205/255.0 green:0/255.0 blue:38/255.0 alpha:1];
        ...
        [mStr appendAttributedString:[self appendingString]];
    }


    {
        NSMutableAttributedString *omg = [[NSMutableAttributedString alloc] initWithString:@"客服电话："];
    ...
    {
        NSMutableAttributedString *omg = [[NSMutableAttributedString alloc] initWithString:@"400-888-888"];
        omg.font = [UIFont systemFontOfSize:15];
        omg.color = [UIColor colorWithRed:18/255.0 green:152/255.0 blue:234/255.0 alpha:1];
        omg.underlineColor = omg.color;
        omg.underlineStyle = NSUnderlineStyleSingle;
...
//            NSLog(@"---- view %@ \n",containerView);
    ...
    label.left = 60;
    label.width = SCREEN_WIDTH -120 ;
    label.height = 80;
    label.top = 440;
//    label.lineBreakMode = 30;
