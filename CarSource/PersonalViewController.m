...
- (void)viewDidLoad {
    ...
    _personalArray = [[NSMutableArray alloc]initWithObjects:@"头像",@"类型",@"账号",@"昵称",@"公司",@"职位", nil];
...
//    NSLog(@"_userName = %@ _companyName = %@  _companyPosition %@ self.textview.text%@",_userName,_companyName,_companyPosition,self.textview.text);
    ...
    [RequestClass postModifyTheUserDataInterfaceRequestWithUserId:login.userId userName:_userName userText:_introduction companyPosition:_companyPosition companyName:_companyName Completion:^(NSMutableArray *saleArray, NSString *errorMessage) {
