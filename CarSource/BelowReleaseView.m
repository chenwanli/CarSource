...
- (void)awakeFromNib{
    ...
    UITextField *numberField = [[UITextField alloc]initWithFrame:CGRectMake(80 , 52, SCREEN_WIDTH -120, 46)];
    ...
    numberField.placeholder = @"输入车源价格";
    ...
    [_scrollView addSubview:numberField];
