...
//    sales.backgroundColor = [UIColor blueColor];
    ...
    LookingOptionsView *looking = [[LookingOptionsView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH, 0, SCREEN_WIDTH, _scrollView.frame.size.height)];
//    looking.backgroundColor = [UIColor redColor];
    [_scrollView addSubview:looking];
