...
- (void)awakeFromNib{
    ...
    for (int j = 0; j < typeArray.count; j++) {
        UILabel *typeLabel = [[UILabel alloc]initWithFrame:CGRectMake(36, 44 *j +60, 80, 45)];
        ...
        UITextField *bankText = [[UITextField alloc]initWithFrame:CGRectMake(115, 44 *j +60, SCREEN_WIDTH -130, 45)];
